        ...
        <main>
          ...
          <div className="homepage-row">
            <div className= "project-item">
              <img src={SLThumbnail} className='center'/>
              <p className='desc'> An interactive UI to demonstrate the proof and applications of Sperner's Lemma, made in Unity</p>
              <ul className="nav-list">
                <li><Link to="/SpernersLemma">Sperner's Lemma</Link></li>
              </ul>
            </div>
            <div className= "project-item">
              <img src={DCThumbnail} className='center'/>
              <p className='desc'> An expository paper on the relationship between the homology and deRham cohomology groups of smooth manifolds, advised by Professor Takashi Kimura</p>
              <ul className="nav-list">
                <li><Link to="/DeRham">DeRham Cohomology</Link></li>
              </ul>
            </div>
            <div className= "project-item">
              <img src={WNThumbnail} className='center'/>
              <p className='desc'> A paper on how the winding number can be used to segment sketches. </p>
              <ul className="nav-list">
